...
class ScreencastsControllerTest < ActionController::TestCase
  ...
  test "should create screencast" do
    assert_difference('Screencast.count') do
      post :create, screencast: { description: @screencast.description, embed: @screencast.embed, length: @screencast.length, title: @screencast.title }
    end
  ...
  test "should update screencast" do
    put :update, id: @screencast, screencast: { description: @screencast.description, embed: @screencast.embed, length: @screencast.length, title: @screencast.title }
    assert_redirected_to screencast_path(assigns(:screencast))
  end
